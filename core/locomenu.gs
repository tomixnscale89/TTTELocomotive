  ...
  public string GetMenuHTML()
  {
    ...
    else if (m_rotationMode == ROTATION_CGI)
    {
      if (SupportsCGIRotation())
      {
        ...
        output.Print("<trainz-object style=slider horizontal theme=ttte-slider width=100% height=32 id='wobbleintensity' min=0.0 max=1.0 value=0.0 page-size=0.001 draw-marks=0 draw-lines=0></trainz-object>");
        output.Print("<br>");
        output.Print("<label>Wobble Speed:</label><br>");
        output.Print("<trainz-object style=slider horizontal theme=ttte-slider width=100% height=32 id='wobblespeed' min=0.0 max=1.0 value=0.0 page-size=0.001 draw-marks=0 draw-lines=0></trainz-object>");
        output.Print("<br>");
        output.Print("<label>Pitch Intensity:</label><br>");
        output.Print("<trainz-object style=slider horizontal theme=ttte-slider width=100% height=32 id='pitchintensity' min=0.0 max=1.0 value=0.0 page-size=0.001 draw-marks=0 draw-lines=0></trainz-object>");
        output.Print("<br>");
        output.Print("</td></tr>");
      }
      else
